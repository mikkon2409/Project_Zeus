...
##############РќРђРџР РђР’Р›Р•РќР�Р• Р’Р РђР–Р•РЎРљР�РҐ Р’РћР РћРў####################################    
    sleep(0.7)
    print('GATE')
    while not button.enter:
        continue
    file.write(str(compass.value(0))+'\n')#Р—РђРџР�РЎРђР› РќРђРџР РђР’Р›Р•РќР�Р• Р’Р РђР–Р•РЎРљР�РҐ Р’РћР РћРў
    print('GATE WROTE')
##############Р’Р РђРўРђР РЎРљРђРЇ Р—РћРќРђ#################################################    
    ...
    while not button.enter:
        continue
    file.write(str(light.value(0))+'\n')#Р—РђРџР�РЎРђР› Р’Р РђРўРђР РЎРљРЈР® Р—РћРќРЈ
...
##################Р›Р�РќР�РЇ Р’Р РђРўРђР РЎРљРћР™ Р—РћРќР«#######################################   
    ...
    while not button.enter:
        continue
    file.write(str(light.value(0))+'\n')#Р—РђРџР�РЎРђР› РЁРўР РђР¤РќРЈР® Р›Р�РќР�Р®
